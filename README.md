...
- Whisper ASR quality control with language-neutral fuzzy matching (safe minor spelling and split/join variations, 90% coverage minimum) and automatic regeneration for up to four attempts.
